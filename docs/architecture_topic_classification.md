...
## 2. Tầng 1: Tiền xử lý & Chiến lược Dữ liệu (Data Engineering Layer)

### 2.1 Canonical Mapping — Đồng nhất nhãn phân mảnh
...
### 2.2 Xử lý mất cân bằng tĩnh — Class weights trên tập Train
...
### 2.3 Chiến dịch “Cứu rỗi khoa hiếm” — FAQ & Strict Pseudo-Labeling (Phase 2)

#### 2.3.1 Triết lý Self-Training trên FAQ
...
#### 2.3.2 Màng lọc kép (Double-Filter)
...
#### 2.3.3 Cảnh báo: Imbalance Amplification (khuếch đại mất cân bằng)
...
#### 2.3.4 Tiền xử lý FAQ phục vụ syllable tokenizer
...
### 3.2 Forward Pass — Từ token hóa đến logits 18 lớp
...
### 3.3 Hàm mất mát: Weighted Cross-Entropy
...
## 4. Tầng 3: Chiến lược Đánh giá (Evaluation Strategy)

### 4.1 Hold-out Test độc lập — tránh Data Leakage
...
### 4.2 Vì sao không chỉ nhìn Accuracy tổng thể?
...
### 4.3 Hiện tượng Semantic Overlap giữa các khoa
...
## 5. Tổng kết Kiến trúc — “Ba trụ cột” của Trạm 2B
...
## 6. Triển khai & Registry (Tham chiếu)
